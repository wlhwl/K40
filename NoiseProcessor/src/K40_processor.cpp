...
void K40_processor::process_K40(double t_min,double time_duration) {
    total_noise=0;
...
double K40_processor::K40poststepdoit(double t0, double t) {
...
void K40_processor::K40alongstepdoit(int cl, double t) {
